...
export function Login({ navigation }) {
    ...
    async function fazerLogin() {
        if (email == '') {
            ...
            if (resultado == 'sucesso') {
                navigation.navigate('ListarProfessores') //replace apaga as telas anteriores da pilha. Caso o usuário clique no voltar do celular não volta para a tela de login
            } else
    ...
    return (
        <View style={estilos.container}>
            ...
            <Text>Dupla: Marcelo Henrique e Evillyn Sthefannya</Text>
            <Text>Turma: 513</Text>
            </View>
        </View>
